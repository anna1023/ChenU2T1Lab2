public class ChatBot {
    ...
    //method that prints comments to birthday
    public void birthday() {
        System.out.println("That's also my best friend's birthday!");
        System.out.println("That's so cool!");
    }

    //method that returns a message about your favorite color
    public String Color (String Color) {
    return Color+(" is also my favorite color! We're like twins!");
    }

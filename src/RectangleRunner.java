...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangle 1's Area: "+rect1.calculateArea()+", BoxVolume: "+rect1.calculateBoxVolume(rect1Height));
        System.out.println("Rectangle 2's Area: "+rect2.calculateArea()+", BoxVolume: "+rect2.calculateBoxVolume(rect2Height));
